...
GLvoid ReSizeGLScene(GLsizei width, GLsizei height)		
{
	...
	glOrtho(-5.0, 5.0, -5.0*(GLfloat)480/(GLfloat)640, 5.0*(GLfloat)480/(GLfloat)640, -5.0, 5.0);
...
int DrawGLScene(GLvoid)									
{
	...
	ctrlpoints[1][1]=4.0+4*sin(time);
	ctrlpoints[2][1]=-4.0-4*sin(time);
	ctrlpoints[1][0]=2.0+4*cos(time);
	ctrlpoints[2][0]=-2.0-4*cos(time);
